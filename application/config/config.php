...
define('_CACHE_EXT_', 'ch');

/*datetime*/
define('_DATETIME_DEFAULT_', 'Y-m-d H:i:s');
...
define('_MAIL_PASS_', 'AryH5jaeBi4EjAErX1xthEvzmgP74zvyNnhVT2oAUwcJ');
define('_MAIL_FROM_', 'no-reply@iappscode.com');
