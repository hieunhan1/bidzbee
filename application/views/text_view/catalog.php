<?php
$html .= '<div id="collection" class="hidden">'.$this->collection.'</div>';
...
$field = array(
    ...
    "label" => ucfirst($name),
    "error" => "Error ".$name,
	"data" => array('home'=>'Home', 'about'=>'About', 'article'=>'Article', 'product'=>'Product', 'contact'=>'Contact', 'no'=>'No'),
);
$value = '';
if(isset($dataCurrent[$name])){
    $value = $dataCurrent[$name];
...
$field = array(
    ...
    "label" => ucfirst($name),
    "error" => "Error ".$name,
	"data" => array('top'=>'Top', 'main'=>'Main', 'left'=>'Left', 'right'=>'Right', 'bottom'=>'Bottom'),
);
$value = '';
if(isset($dataCurrent[$name])){
    $value = $dataCurrent[$name];
